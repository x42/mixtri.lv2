...
cat >> lv2ttl/mixtri.lv2.ttl.in << EOF
    ...
    lv2:scalePoint [ rdfs:label "Pulsewidth"; rdf:value 3.0 ; ] ;
    lv2:scalePoint [ rdfs:label "Pulsetrain"; rdf:value 4.0 ; ] ;
    lv2:scalePoint [ rdfs:label "Window enter"; rdf:value 5.0 ; ] ;
    lv2:scalePoint [ rdfs:label "Window leave"; rdf:value 6.0 ; ] ;
    lv2:scalePoint [ rdfs:label "Hysteresis"; rdf:value 7.0 ; ] ;
    lv2:scalePoint [ rdfs:label "Runt"; rdf:value 8.0 ; ] ;
    lv2:scalePoint [ rdfs:label "Dropout"; rdf:value 9.0 ; ] ;
    lv2:scalePoint [ rdfs:label "Drop-in"; rdf:value 10.0 ; ] ;
    lv2:scalePoint [ rdfs:label "RMS"; rdf:value 11.0 ; ] ;
    lv2:scalePoint [ rdfs:label "LPF"; rdf:value 12.0 ; ] ;
  ] , [
    a lv2:ControlPort ,
      lv2:InputPort ;
    lv2:index $(($IDX + 2));
